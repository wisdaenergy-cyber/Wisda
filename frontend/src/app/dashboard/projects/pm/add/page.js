...
export default function CreateBlogPage() {
  ...
  try {
    await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/project/pm/upload`, formData, {
      headers: {
          ...
          <div className="bg-[#F8F6EF] rounded-xl border border-teal-800 p-6">
            <div className="flex items-center gap-2 mb-6 text-[#278188]">
              <div
                ...
                onClick={() => {
                  router.push("/dashboard/projects/pm");
                }}
              >
                <ArrowLeft size={20} />
              </div>
              <h2 className="text-2xl font-semibold">Create PM Project</h2>
            </div>
