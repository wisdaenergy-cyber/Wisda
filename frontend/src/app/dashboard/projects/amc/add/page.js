...
export default function CreateBlogPage() {
  ...
  try {
    await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/project/amc/upload`, formData, {
      headers: {
    ...
    toast.success("AMC Project created successfully! ✅");
    setTitle("");
    setContent("");
    setLocation("");
    setFile(null);
        ...
        <div className="p-8">
          <div className="bg-[#F8F6EF] rounded-xl border border-teal-800 p-6">
            <div className="flex items-center gap-2 mb-6 text-[#278188]">
              ...
              <h2 className="text-2xl font-semibold">Create AMC Project</h2>
            </div>
