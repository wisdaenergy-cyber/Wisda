...
export default function CreateBlogPage() {
  ...
  if (!title.trim() || !content.trim() || !location.trim()) {
    toast.error("Title ,Content and Location cannot be empty.");
    return;
  }
  ...
  try {
    await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/project/ground/upload`, formData, {
      headers: {
    ...
    toast.success("Ground Project created successfully! ✅");
    setTitle("");
    setContent("");
    setLocation("");
    setFile(null);
    setSelectedFileName("");
    router.push("/dashboard/projects/ground");
  } catch (err) {
    toast.error("Something went wrong while creating the roof Project.");
    console.error(err);
  }
};
        ...
        <div className="p-8">
          <div className="bg-[#F8F6EF] rounded-xl border border-teal-800 p-6">
            <div className="flex items-center gap-2 mb-6 text-[#278188]">
              ...
              <h2 className="text-2xl font-semibold">Create Ground Project</h2>
            </div>

            <label className="text-[#278188] font-medium">Title</label>
            <input
              type="text"
              value={title}
            ...
            />
             ...
             <label className="text-[#278188] font-medium">Location</label>
            <input
              type="text"
              value={location}
            ...
            <label className="text-[#278188] font-medium">Content</label>
